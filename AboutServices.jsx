  ...
  return (
    <div style={{ background: 'var(--crema)', position: 'relative', overflow: 'hidden' }}>
      ...
      <section id="sobre-mi" style={{
        ...
        <figure className="reveal" style={{ marginTop: '3rem' }}>
          <img src={(window.__resources && window.__resources.mijalLima) || "assets/mijal-lima-wanifra.jpg"}
               alt={lang === 'es' ? 'Mijal Iastrebner dando una charla en el LATAM Media Leaders Summit de WAN-IFRA, Lima 2026' : 'Mijal Iastrebner speaking at the WAN-IFRA LATAM Media Leaders Summit, Lima 2026'}
               style={{ width: '100%', display: 'block', borderRadius: 20, objectFit: 'cover' }} />
          <figcaption style={{ fontSize: '.8rem', color: 'var(--ink-muted)', lineHeight: 1.6, marginTop: '.9rem' }}>
            <T es={<><strong style={{ color: 'var(--ink-light)', fontWeight: 700 }}>«¿En qué negocio estamos realmente?»</strong> — LATAM Media Leaders Summit, WAN-IFRA. Lima, 2026.</>}
               en={<><strong style={{ color: 'var(--ink-light)', fontWeight: 700 }}>“What business are we really in?”</strong> — LATAM Media Leaders Summit, WAN-IFRA. Lima, 2026.</>} />
          </figcaption>
        </figure>
      </section>
    </div>
