      ...
      <div style={inner}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <div className="parallax-portrait" style={{
            ...
            <img src={(window.__resources && window.__resources.portraitLaptop) || "assets/portrait-laptop.png"} alt="Mijal Iastrebner"
...
function Stats() {
  const stats = [
    ...
    { val: 2000, suffix: '+',   es: 'Organizaciones impactadas', en: 'Organizations impacted' },
    { val: 77, suffix: '',      es: 'Países', en: 'Countries' },
    { val: 10.4, suffix: 'k+',   es: 'Personas formadas', en: 'People trained' },
  ];
  return (
