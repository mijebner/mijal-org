      ...
      <div style={{
        ...
        <div className="reveal-right" style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{
            ...
            <img src={(window.__resources && window.__resources.portraitPhone) || "assets/portrait-phone.png"} alt="Mijal Iastrebner"
  ...
  return (
    <footer style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '.8rem' }}>
        <img src={(window.__resources && window.__resources.logoMentaSmall) || "assets/logo-menta-small.png"} alt="MI" style={{ height: 28, opacity: .7 }} />
