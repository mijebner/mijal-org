...
function Library() {
  ...
  { id: 'unesco', featured: true,
    ...
    cover: (window.__resources && window.__resources.unescoCover) || 'assets/unesco-cover.png',
  ...
  { type: { es: 'Plantilla', en: 'Template' }, typeKey: 'plantilla',
    cover: (window.__resources && window.__resources.coverPropuesta) || 'assets/cover-propuesta.png',
  ...
  { type: { es: 'Guía', en: 'Guide' }, typeKey: 'guia',
    cover: (window.__resources && window.__resources.coverDisenarSinDrama) || 'assets/cover-disenar-sin-drama.png',
  ...
  { type: { es: 'Canvas', en: 'Canvas' }, typeKey: 'canvas',
    cover: (window.__resources && window.__resources.coverMapeoCostos) || 'assets/cover-mapeo-costos.png',
  ...
  { type: { es: 'Decálogo', en: 'Checklist' }, typeKey: 'decalogo',
    cover: (window.__resources && window.__resources.coverDecalogo) || 'assets/cover-decalogo.png',
    ...
    <div style={{ background: 'var(--naranja)', position: 'relative', overflow: 'hidden' }}>
      ...
      <section id="biblioteca" style={{
        ...
        <p style={{ marginTop: '2rem', fontSize: '.85rem', opacity: .85 }}>
          ...
          en={<><strong style={{ opacity: 1 }}>All the resources are free.</strong> Click to request them.</>} />
        </p>
      </section>
  ...
  return (
    ...
    style={{
      ...
      <div style={{
        ...
        <img src={(window.__resources && window.__resources.unescoCover) || "assets/unesco-cover.png"} alt="Media Startups and Viability — A Guide for Women Leaders"
      ...
      <div>
        ...
        <span className="link-underline" style={{
          ...
          <T es="Pedir el recurso" en="Request the resource" />
          <ArrowOut />
        </span>
      </div>
    </button>);
...
function ResourceModal({ item, onClose }) {
  ...
  const subject = encodeURIComponent(lang === 'es' ?
  `Solicito recurso: ${title}` :
...
I'd love to receive the resource "${title}".
      ...
      <div onClick={(e) => e.stopPropagation()} className="resource-modal" style={{
        ...
        <div style={{ padding: '2.2rem 2rem 2rem' }}>
          ...
          <div style={{
            ...
            <strong style={{ color: 'var(--violeta)' }}><T es="¿Cómo lo recibís?" en="How do you get it?" /></strong>{' '}
            <T es="Hacé clic en el botón y se abre un correo. Cuando lo envías, recibís el recurso automáticamente en tu casilla."
            en="Click the button and an email opens. Once you send it, you'll get the resource straight to your inbox." />
          </div>
          ...
          onMouseLeave={(e) => {e.currentTarget.style.background = 'var(--naranja)';e.currentTarget.style.transform = 'translateY(0)';}}>
            <T es="Pedir el recurso por mail" en="Request it by email" />
            <ArrowOut />
          </a>
          <p style={{ fontSize: '.72rem', color: 'var(--ink-muted)', marginTop: '.7rem' }}>
            <T es={<>Te llega a <strong style={{ color: 'var(--ink)' }}>mijebner@gmail.com</strong>. Respondo con el recurso adjunto.</>}
            en={<>It reaches <strong style={{ color: 'var(--ink)' }}>mijebner@gmail.com</strong>. I'll reply with the resource attached.</>} />
          </p>
        </div>
      </div>
    </div>);
